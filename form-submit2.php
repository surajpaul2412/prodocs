...
{
		$subject = "Contact Form Inquiry Form submitted at Prodocs";
		...
		$message .= "<tr style='background: #eee;'><td><strong>Subject:</strong> </td><td>" . strip_tags($_REQUEST['usubject']) . "</td></tr>";
