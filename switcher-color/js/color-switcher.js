...
(function($){
	...
	$("body").sCustomizer({
		...
		// patterns: {
		// 	pattern_1: "switcher-color/images/pattern/pattern_1.png",
		// 	pattern_2: "switcher-color/images/pattern/pattern_2.png",
		// 	pattern_3: "switcher-color/images/pattern/pattern_3.png",
		// 	pattern_4: "switcher-color/images/pattern/pattern_4.png",
		// 	pattern_5: "switcher-color/images/pattern/pattern_5.png",
		// 	pattern_6: "switcher-color/images/pattern/pattern_6.png",
		// 	pattern_7: "switcher-color/images/pattern/pattern_7.png",
		// 	pattern_8: "switcher-color/images/pattern/pattern_8.png",
		// },
		// bgImageSwitcher: true,
		// bgImages: {
		// 	bg_image_1: {
		// 		large: "switcher-color/images/bg-img/large/1.jpg",
		// 		small: "switcher-color/images/bg-img/small/1.jpg",
		// 	},
		// 	bg_image_2: {
		// 		large: "switcher-color/images/bg-img/large/2.jpg",
		// 		small: "switcher-color/images/bg-img/small/2.jpg",
		// 	},
		// 	bg_image_3: {
		// 		large: "switcher-color/images/bg-img/large/3.jpg",
		// 		small: "switcher-color/images/bg-img/small/3.jpg",
		// 	},
		// 	bg_image_4: {
		// 		large: "switcher-color/images/bg-img/large/4.jpg",
		// 		small: "switcher-color/images/bg-img/small/4.jpg",
		// 	},
		// 	bg_image_5: {
		// 		large: "switcher-color/images/bg-img/large/5.jpg",
		// 		small: "switcher-color/images/bg-img/small/5.jpg",
		// 	},
		// 	bg_image_6: {
		// 		large: "switcher-color/images/bg-img/large/6.jpg",
		// 		small: "switcher-color/images/bg-img/small/6.jpg",
		// 	}
		// },
		...
		// 	layout_two: "boxed"
		// },
		// logo: "switcher-color/images/logo.png"
	});
})(jQuery);